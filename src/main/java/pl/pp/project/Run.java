...
public class Run {
    public static void main(String[] args) {
        ...
        LocalDate datePayment1 = LocalDate.of(2016, Month.OCTOBER, 19);
        LocalDate datePayment2 = LocalDate.of(2016, Month.OCTOBER, 25);
        LocalDate datePayment3 = LocalDate.of(2016, Month.OCTOBER, 28);
        ...
        Payment payment1 = new Payment(datePayment1, BigDecimal.valueOf(400.0), false);
        Payment payment2 = new Payment(datePayment2, BigDecimal.valueOf(300.0), false);
